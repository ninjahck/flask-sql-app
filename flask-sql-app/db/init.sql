...
INSERT INTO `tbl_likes` VALUES (3,1,1,1);
...
INSERT INTO `tbl_user` VALUES (1,'test1','test@123.com','pbkdf2:sha256:150000$J80Mcugv$ace9d451132dccc72b46535177a96bc22b8aa423e4976b23f0c1c834b60b0f4d');
...
INSERT INTO `tbl_wish` VALUES (3,'Check Test data','first test implementation',1,'2020-06-20 17:24:45','static/Uploads/75a16c46-7fa3-4ec2-9266-fb213beb4d2a.png',1,0);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `sp_deleteWish`(
IN p_wish_id bigint,
IN p_user_id bigint
)
BEGIN
...
-- Dump completed on 2020-06-21  7:58:22
